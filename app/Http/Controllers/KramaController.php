...
class KramaController extends Controller
{
    ...
    public function index()
    {
        ...
        $title = 'Data Krama';
        $krama_desa = Krama::with('jabatan', 'jenisKelamin', 'status', 'statusKeluarga', 'tempekan', 'banjarAdat', 'jenispendidikan', 'jenispekerjaan', 'keterangan', 'nmddy', 'ketuaDadya')->where('stts_dlm_klrg', '=', '1')->get();
        return view('admin.krama.index', compact('krama_desa', 'title'));
    }

    public function kramaPdf()
    {
        $data = [
            'kramaPdf' => Krama::with('jabatan', 'jenisKelamin', 'status', 'statusKeluarga', 'tempekan', 'banjarAdat', 'jenispendidikan', 'jenispekerjaan', 'keterangan', 'nmddy', 'ketuaDadya')->get()
        ];

        $downloadPdf = PDF::loadview('admin.krama.pdf', $data);
        return $downloadPdf->download('krama.pdf');
    }
    ...
    {
        // dd($ValidateData);
        // return $request->file('ft')->store('image-krama');
    ...
    {
        return Excel::download(new KramaExport, 'krama.xls');
    }
