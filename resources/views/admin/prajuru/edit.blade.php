    ...
    <form action="{{ route('prajuru.update', $prajuru->id) }}" method="POST">
        ...
        <div class="row">
            <div class="form-group col">
                ...
                <input type="text" name='tempat' id="tempat" class="form-control @error('tempat') is-invalid @enderror" value="{{ old('tempat', $prajuru->tempat) }}" placeholder="Tempat Lahir">
                @error('tempat')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                ...
                <div class="d-block">
                    <div class="custom-control custom-radio">
                        ...
                        <div class="custom-control-inline pr-3">
                            <input type="radio" id="{{ $item->id }}" name="jk" class="custom-control-input @error('jk') is-invalid @enderror" value="{{ $item->id }}" {{old('jk') == $item->id||$prajuru->jk == $item->id ? 'checked' : null}}>
