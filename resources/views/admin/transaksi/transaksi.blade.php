                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex d-inline-flex">
                            ...
                            <a href="{{ route('kwitansi', $item->id) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Nota">
                                <i class="fa fa-file"></i>
                            </a>
                            <a href="{{ route('kwitansi1', $item->id) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="View">
                                <i class="fa fa-file"></i>
                            </a>
                        </div>
                    </td>
