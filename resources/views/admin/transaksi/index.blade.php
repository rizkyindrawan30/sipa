        ...
        <div class="card">
            <div class="card-body p-3">
                <form action="{{ route('pembayaran') }}">
                    ...
                    <!-- <a href="#" class="btn btn-primary" id="konfirmasi">Konfirmasi</a> -->
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <form action="{{ route('transaksi') }}" method="post">
                        ...
                        @if (request('cari_nik') || request('cari_jenis') || request('cari_periode'))
                        <a href="#" class="btn btn-success" id="konfirmasi">Bayar</a>
...
@push('javascript')
<script>
    const bayar = document.querySelector('#konfirmasi');
    bayar.addEventListener('click', function(e) {
        e.preventDefault();
        Swal.fire({
            title: 'Apakah anda yakin?',
            text: "Melakukan pembayaran sekarang!",
            icon: 'warning',
